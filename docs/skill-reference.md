...
**触发 / Trigger:** `/repo-knowledge:rk-create <git-url>`

**参数 / Parameters:**

| 参数 | 类型 | 说明 |
|------|------|------|
| `git-url` | string (required) | HTTPS 或 SSH 格式的 Git 仓库地址 / HTTPS or SSH Git URL |
...
**触发 / Trigger:** `/repo-knowledge:rk-search <query>`

**参数 / Parameters:**

| 参数 | 类型 | 说明 |
|------|------|------|
| `query` | string (required) | 自然语言查询，任意语言 / Natural language query, any language |
...
**触发 / Trigger:** `/repo-knowledge:rk-update <project-name>`

**参数 / Parameters:**

| 参数 | 类型 | 说明 |
|------|------|------|
| `project-name` | string (required) | 已注册的项目名 / Registered project name |
...
**触发 / Trigger:** `/repo-knowledge:rk-list`
...
**触发 / Trigger:** `/repo-knowledge:rk-delete <project-name>`

**参数 / Parameters:**

| 参数 | 类型 | 说明 |
|------|------|------|
| `project-name` | string (required) | 要删除的项目名 / Project name to delete |
